...
public class Empleado extends Persona {
     ...
     * 
     * - La línea public class Empleado extends
     * Persona establece la herencia. La palabra clave extends indica que la
     * clase Empleado "extiende" o hereda todas las propiedades y métodos (que
     * sean públicos o protegidos) de la clase Persona.
     *
     * - Esto es útil porque evita tener que reescribir atributos comunes como id,
     * dni, nombre, apellido, etc. en la clase Empleado. Simplemente se reusan
     * de la clase Persona.
     *
     * 2. Atributos propios del Empleado 
     * -
     * Además de lo que hereda, la clase
     ...
     *
     * 3. Constructores 
     * - Los constructores son métodos especiales que se usan
